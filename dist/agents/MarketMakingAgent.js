...
exports.MarketMakingAgent = void 0;
...
class MarketMakingAgent extends BaseAgent_1.BaseAgent {
    ...
    async analyze(marketData, portfolio) {
        ...
        for (const [asset, data] of marketData) {
            ...
            const maxSize = Math.min(portfolio.availableUsd * this.mmConfig.maxPositionPercent, this.mmConfig.maxOrderSize) / midPrice;
            ...
            logger_1.logger.info(`Market making signal for ${asset}: Bid ${bidPrice.toFixed(2)}, Ask ${askPrice.toFixed(2)}`);
        }
    ...
    setConfig(config) {
        ...
        logger_1.logger.info('Market making config updated', this.config);
    }
    /**
     ...
     */
    calculateOptimalSpread(volume24h, volatility) {
     ...
     */
    estimateVolatility(bid, ask) {
        if (bid === 0)
            return 0;
        return (ask - bid) / bid;
    }
}
exports.MarketMakingAgent = MarketMakingAgent;
//# sourceMappingURL=MarketMakingAgent.js.map