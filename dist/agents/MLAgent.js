...
class MLAgent extends BaseAgent_1.BaseAgent {
    constructor(config) {
        super(config);
    ...
    async analyze(marketData, portfolio) {
        ...
        for (const asset of topAssets) {
            ...
            const mlSignal = this.generateMLSignal(asset, data, portfolio, { rsi, sma20, sma50, ema12, ema26, macd, bollinger, momentum });
            if (mlSignal)
     ...
     */
    generateBasicSignal(data, portfolio) {
     ...
     */
    generateMLSignal(asset, data, portfolio, indicators) {
        let buyScore = 0;
        let sellScore = 0;
        const signals = [];
        // RSI analysis
...
//# sourceMappingURL=MLAgent.js.map